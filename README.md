...
| **Depth Camera**          | [DepthCameraSensor](https://gazebosim.org/api/sensors/9/classgz_1_1sensors_1_1DepthCameraSensor.html)        | [`<depth_camera>`](http://sdformat.org/spec?ver=1.12&elem=sensor#sensor_depth_camera)              | Captures depth information                         |
| **Doppler Velocity Log**  | [DopplerVelocityLog](https://gazebosim.org/api/sensors/9/classgz_1_1sensors_1_1DopplerVelocityLog.html)      | [`<dvl>`](http://sdformat.org/spec?ver=1.12&elem=sensor#sensor_dvl)                                | Measures relative velocity of an underwater vehicle |
...
| **RGBD Camera**           | [RGBDCameraSensor](https://gazebosim.org/api/sensors/7/classgz_1_1sensors_1_1RgbdCameraSensor.html)          | [`<rgbd_camera>`](http://sdformat.org/spec?ver=1.12&elem=sensor#sensor_rgbd_camera)               | Captures RGB + Depth streams                       |
